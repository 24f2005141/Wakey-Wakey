...
export const AlarmTriggeredScreen: React.FC<AlarmTriggeredScreenProps> = ({
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-50 bg-[#6a152f] text-white flex flex-col items-center justify-between px-6 pt-10 pb-8 overflow-y-auto"
    >
      {/* Top Section */}
      <div className="w-full flex flex-col items-center text-center space-y-3">
        ...
        {/* Proximity Monospace Badge matching Image 7 */}
        <div className="bg-[#520f23]/80 border border-[#8a2448]/50 px-5 py-2 rounded-full flex items-center gap-2 text-xs font-spacemono text-[#fcd7e1] shadow-inner">
          ...
          <span>
            near_me You are now {formatDistance(currentDistance)} away.
          </span>
        </div>
      </div>

      {/* Center Stylized Geofence Map Graphic matching Image 7 */}
      <div className="my-6 w-full max-w-sm aspect-square bg-[#381622] rounded-3xl overflow-hidden border-[3px] border-[#4a1325] shadow-2xl relative flex items-center justify-center">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          ...
          {/* Static Boundary Circle matching Image 7 */}
      ...
      {/* Action Buttons Section matching Image 7 */}
